...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = LAYOUT_65_with_macro(
    ...
    KC_MPLY,     KC_MUTE,     KC_TAB,  KC_Q,    KC_W,    KC_E,       KC_R,   KC_T,      KC_Y,              KC_U,    KC_I,        KC_O,        KC_P,    KC_LBRC, KC_RBRC, KC_BSLS, KC_PGUP, \
    KC_MPRV,     KC_MNXT,     KC_LCTL, KC_A,    KC_S,    KC_D,       KC_F,   KC_G,      KC_H,              KC_J,    KC_K,        KC_L,        KC_SCLN, KC_QUOT, KC_ENT,  KC_PGDN, \
  ...
  [FN] = LAYOUT_65_with_macro(
    ...
    _______, _______, _______, _______, _______, _______, _______,          KC_0,  XXXXXXX, TG(MOD_WIN), _______, _______, _______, _______, _______
  ),
