...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_65_with_macro(
    ...
    KC_F9,   KC_F10,  KC_LGUI, KC_LALT, KC_LCTL, MO(_FN0),KC_SPC,           KC_SPC,  _______, MO(_FN1), MO(_FN2), MO(_FN3), KC_LEFT, KC_DOWN, KC_RGHT
  ),
  ...
  [_FN0] = LAYOUT_65_with_macro(
    ...
    KC_F13,  KC_F14,  _______, _______, KC_UP,   _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
    KC_F15,  KC_F16,  _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______, _______, _______, \
    KC_F17,  KC_F18,  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
