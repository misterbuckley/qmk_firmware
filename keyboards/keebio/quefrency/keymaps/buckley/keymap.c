...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = LAYOUT_65_with_macro(
    ...
    TD(TD_LOCK), TD(TD_SHOT), KC_LGUI, KC_LALT, KC_LCTL, MO(NUMPAD), LT(MOUSE, KC_SPC), LT(MOUSE, KC_SPC), XXXXXXX, TD(TD_MAC1), TD(TD_MAC2), DM_RSTP, KC_LEFT, KC_DOWN, KC_RGHT
  ),
  ...
  [MOUSE] = LAYOUT_65_with_macro(
    ...
    _______, _______, _______, _______, GO_BACK, KC_BTN2, KC_BTN1, GO_FWRD, GO_BACK, KC_BTN1, KC_BTN2, GO_FWRD, _______, _______, _______, _______, _______, \
    _______, _______, _______, _______, KC_MS_L, KC_MS_U, KC_MS_D, KC_MS_R, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, _______, _______, _______, _______, \
    _______, _______, _______, _______, KC_WH_L, KC_WH_U, KC_WH_D, KC_WH_R, KC_WH_L, KC_WH_D, KC_WH_U, KC_WH_R, _______, _______, _______, _______, \
