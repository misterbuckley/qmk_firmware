...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_65_with_macro(
    ...
    TD(TD_LOCK), TD(TD_PWR), KC_LGUI, KC_LALT, KC_LCTL, MO(_FN0),KC_SPC,           KC_SPC,  _______, MO(_FN1), MO(_FN2), MO(_FN3), KC_LEFT, KC_DOWN, KC_RGHT
  ),
...
qk_tap_dance_action_t tap_dance_actions[] = {
  ...
  [TD_PWR] = ACTION_TAP_DANCE_DOUBLE(_______, KC_POWER),
};
